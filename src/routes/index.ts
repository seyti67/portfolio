			...
			projects: [
				{
					...
					images: ['images/kaki/chat.png', 'images/kaki/friends.png', 'images/kaki/login.png']
				},
				{
					...
					images: [
						'images/blumenroeder/nav.png',
						'images/blumenroeder/home.png',
						'images/blumenroeder/page.png',
						'images/blumenroeder/nav2.png'
					]
				},
				{
					...
					images: [
						'images/tuyaux/valeurs.png',
						'images/tuyaux/graphique.png',
						'images/tuyaux/rapport.png'
					]
				},
				{
					...
					images: ['images/graph/villes.png', 'images/graph/chemin.png', 'images/graph/wide.png']
				},
				{
					...
					images: ['images/complex/exp.png', 'images/complex/cos2+sin2.png']
				},
				{
					title: 'Draw Together',
					description:
					...
					images: [
						'images/draw/rooms.png',
						'images/draw/dessin1.png',
						'images/draw/dessin2.png',
						'images/draw/result.png'
					]
				}
			]
		}
